  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glow: "bg-primary text-primary-foreground shadow-lg hover:shadow-[0_0_40px_hsl(175_80%_50%/0.4)]",
        success: "bg-success text-primary-foreground shadow-lg shadow-success/25 hover:bg-success/90",
        editor: "bg-secondary/50 text-muted-foreground hover:bg-secondary hover:text-foreground border border-border/50",
        run: "bg-success text-primary-foreground shadow-lg shadow-success/30 hover:bg-success/90 font-semibold",
      },
      size: {
